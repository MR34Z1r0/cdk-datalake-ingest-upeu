...
class CdkDatalakeIngestUpeuGroupStack(Stack):
    ...
    def _create_jobs_for_table(self, row, logical_name, credentials):
        ...
        datasource = self.PROJECT_CONFIG.app_config.get('datasource', 'Upeu').lower()
        ...
        extract_job_config = GlueJobConfig(
            ...
            default_arguments={
                ...
                '--extra-py-files': f"s3://{self.s3_artifacts_bucket.bucket_name}/{self.Paths.LOCAL_ARTIFACTS_GLUE_LAYER}/sofia_libs.zip",
