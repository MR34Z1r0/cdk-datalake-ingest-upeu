...
class CdkDatalakeIngestUpeuStack(Stack):
        ...
        for db_name in db_names:
            ...
            crawler_job_config = GlueJobConfig(
                ...
                default_arguments={
                    ...
                    '--extra-py-files': f"s3://{self.s3_artifacts_bucket.bucket_name}/athenea/Upeu/aws-glue/layer/sofia_libs.zip",
    ...
    def _create_secrets(self):
        ...
        data_source = self.PROJECT_CONFIG.app_config.get('datasource', 'Upeu').lower()  # Should be 'Upeu'
